...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // LCTL ---  ---  --- SPC  MO(1) RGUI MO(2) ESC BTN1 BTN2 RSFT
  [0] = LAYOUT_universal(
    ...
    KC_LCTL  , _______  , _______  , _______  ,KC_SPC, MO(1),     KC_RGUI,MO(2),KC_ESC,KC_BTN1,KC_BTN2, KC_RSFT
  ),
    // Layer 1: シンボルレイヤー
    ...
    // \    |    (    [    {              }    ]    )    _    -
    // =    +    '    "    `              ~    :    ;    ?    /
    // LCTL ---  ---  --- SPC  ---  RGUI ---  ESC BTN1 BTN2 RSFT
  [1] = LAYOUT_universal(
    ...
    KC_LCTL  , _______  , _______  , _______  ,KC_SPC, _______,     KC_RGUI,_______,KC_ESC,KC_BTN1,KC_BTN2, KC_RSFT
    ...
    // F11  F12  TAB  ENT  <              >    [    ]    ,    .
    // LCTL TAB  LALT ---  SPC  ---  RGUI ENT  .    ,    RGUI RSFT
  [2] = LAYOUT_universal(
    ...
    KC_LCTL   , KC_TAB   , KC_LALT  , _______  , KC_SPC   , _______  ,      KC_RGUI  , KC_ENT   , KC_DOT   , KC_COMM  , KC_RGUI  , KC_RSFT
  ), 
  ...
  [3] = LAYOUT_universal(
    ...
    KC_LCTL  , _______  , _______  , _______  , _______  , _______  ,      _______  , _______  , _______  , _______  , KC_RGUI  , KC_RSFT
  ),
};
// clang-format on
